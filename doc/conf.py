...
project = u'PiPianoUi'
copyright = u'2018, Doug Napoleone'
author = u'Doug Napoleone'
...
pdf_documents = [(master_doc, u'pipianoui', project, author),]
...
html_theme_options = {
    'description': "Graphical UI and hooks for Pimoroni's Raspberry Pi Piano-HAT",
    'github_user': 'dougn',
    'github_repo': 'PyPianoUi',
    'fixed_sidebar': True,
}
...
htmlhelp_basename = 'PiPianoUidoc'
...
latex_documents = [
    (master_doc, 'PiPianoUi.tex', u'PiPianoUi Documentation',
...
man_pages = [
    (master_doc, 'pipianoui', u'PiPianoUi Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PiPianoUi', u'PiPianoUi Documentation',
     author, 'PiPianoUi', 'One line description of project.',
     'Miscellaneous'),
]
